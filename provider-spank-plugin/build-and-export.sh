...
podman run -v "$(pwd)/artifacts/8.6:/out" --rm spank-builder:8.6 sh -c "cp /artifacts/* /out/"
podman run -v "$(pwd)/artifacts/9.2:/out" --rm spank-builder:9.2 sh -c "cp /artifacts/* /out/"
