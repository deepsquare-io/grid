...
type Job struct {
	...
	Cost             *JobCost       `protobuf:"bytes,7,opt,name=cost,proto3" json:"cost,omitempty"`
	Time             *JobTime       `protobuf:"bytes,8,opt,name=time,proto3" json:"time,omitempty"`
	JobName          []byte         `protobuf:"bytes,9,opt,name=job_name,json=jobName,proto3" json:"job_name,omitempty"`
	HasCancelRequest bool           `protobuf:"varint,10,opt,name=has_cancel_request,json=hasCancelRequest,proto3" json:"has_cancel_request,omitempty"`
}
...
func (x *Job) GetHasCancelRequest() bool {
	if x != nil {
		return x.HasCancelRequest
	}
	return false
}
...
type JobCost struct {
	...
	PendingTopUp              *BigInt `protobuf:"bytes,3,opt,name=pending_top_up,json=pendingTopUp,proto3" json:"pending_top_up,omitempty"`
	DelegateSpendingAuthority bool    `protobuf:"varint,4,opt,name=delegate_spending_authority,json=delegateSpendingAuthority,proto3" json:"delegate_spending_authority,omitempty"`
}
...
func (x *JobCost) GetPendingTopUp() *BigInt {
	if x != nil {
		return x.PendingTopUp
	}
	return nil
}

func (x *JobCost) GetDelegateSpendingAuthority() bool {
	if x != nil {
		return x.DelegateSpendingAuthority
	}
	return false
}
...
type JobDefinition struct {
	...
	GpuPerTask        uint64 `protobuf:"varint,1,opt,name=gpu_per_task,json=gpuPerTask,proto3" json:"gpu_per_task,omitempty"`
	MemPerCpu         uint64 `protobuf:"varint,2,opt,name=mem_per_cpu,json=memPerCpu,proto3" json:"mem_per_cpu,omitempty"`
	CpuPerTask        uint64 `protobuf:"varint,3,opt,name=cpu_per_task,json=cpuPerTask,proto3" json:"cpu_per_task,omitempty"`
	Ntasks            uint64 `protobuf:"varint,4,opt,name=ntasks,proto3" json:"ntasks,omitempty"`
	BatchLocationHash string `protobuf:"bytes,5,opt,name=batch_location_hash,json=batchLocationHash,proto3" json:"batch_location_hash,omitempty"`
	StorageType       uint32 `protobuf:"varint,6,opt,name=storage_type,json=storageType,proto3" json:"storage_type,omitempty"`
}
...
func (x *JobDefinition) GetGpuPerTask() uint64 {
	if x != nil {
		return x.GpuPerTask
	}
	return 0
...
func (x *JobDefinition) GetCpuPerTask() uint64 {
	if x != nil {
		return x.CpuPerTask
	}
	return 0
...
func (x *JobDefinition) GetBatchLocationHash() string {
	if x != nil {
...
func (x *JobDefinition) GetStorageType() uint32 {
	if x != nil {
...
type JobTime struct {
	...
	CancelRequestTimestamp *BigInt `protobuf:"bytes,3,opt,name=cancel_request_timestamp,json=cancelRequestTimestamp,proto3" json:"cancel_request_timestamp,omitempty"`
	BlockNumberStateChange *BigInt `protobuf:"bytes,4,opt,name=block_number_state_change,json=blockNumberStateChange,proto3" json:"block_number_state_change,omitempty"`
}
...
func (x *JobTime) GetCancelRequestTimestamp() *BigInt {
	if x != nil {
		return x.CancelRequestTimestamp
	}
	return nil
}

func (x *JobTime) GetBlockNumberStateChange() *BigInt {
	if x != nil {
		return x.BlockNumberStateChange
	}
	return nil
}
...
var file_metrics_v1_metrics_proto_rawDesc = []byte{
	...
	0x54, 0x6f, 0x6f, 0x4d, 0x75, 0x63, 0x68, 0x22, 0xea, 0x02, 0x0a, 0x03, 0x4a, 0x6f, 0x62, 0x12,
	...
	,
...
var file_metrics_v1_metrics_proto_depIdxs = []int32{
	...
	4,  // 22: metrics.v1.JobCost.pending_top_up:type_name -> metrics.v1.BigInt
	4,  // 23: metrics.v1.JobTime.start:type_name -> metrics.v1.BigInt
	4,  // 24: metrics.v1.JobTime.end:type_name -> metrics.v1.BigInt
	4,  // 25: metrics.v1.JobTime.cancel_request_timestamp:type_name -> metrics.v1.BigInt
	4,  // 26: metrics.v1.JobTime.block_number_state_change:type_name -> metrics.v1.BigInt
