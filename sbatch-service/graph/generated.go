...
input StepRun {
  ...
  shell: String
    ...
    @constraint(format: "omitempty,oneof=/bin/bash /bin/ash /bin/sh ENTRYPOINT")
  """
...
func (ec *executionContext) unmarshalInputBore(ctx context.Context, obj interface{}) (model.Bore, error) {
	...
	fieldsInOrder := [...]string{"address", "boreAddress", "port", "targetPort", "secret"}
