...
#ifndef GOOGLE_PROTOBUF_INCLUDED_supervisor_2fv1alpha1_2fjob_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_supervisor_2fv1alpha1_2fjob_2eproto_2epb_2eh
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_supervisor_2fv1alpha1_2fjob_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::supervisor::v1alpha1::SetJobStatusRequest* Arena::CreateMaybeMessage<::supervisor::v1alpha1::SetJobStatusRequest>(Arena*);
template <>
::supervisor::v1alpha1::SetJobStatusResponse* Arena::CreateMaybeMessage<::supervisor::v1alpha1::SetJobStatusResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
constexpr JobStatus JobStatus_MAX = static_cast<JobStatus>(10);
constexpr int JobStatus_ARRAYSIZE = 10 + 1;
...
inline const std::string& JobStatus_Name(JobStatus value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<JobStatus_descriptor,
                                                 0, 10>(
...
inline PROTOBUF_ALWAYS_INLINE void SetJobStatusRequest::set_name(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void SetJobStatusRequest::set_allocated_name(std::string* value) {
...
template <>
struct is_proto_enum<::supervisor::v1alpha1::JobStatus> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_supervisor_2fv1alpha1_2fjob_2eproto_2epb_2eh
