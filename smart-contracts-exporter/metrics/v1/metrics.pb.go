...
type Metrics struct {
	...
	TotalJobsPanicked      []*LabeledMetric `protobuf:"bytes,11,rep,name=total_jobs_panicked,json=totalJobsPanicked,proto3" json:"total_jobs_panicked,omitempty"`
	TotalCreditSpent       []*LabeledMetric `protobuf:"bytes,12,rep,name=total_credit_spent,json=totalCreditSpent,proto3" json:"total_credit_spent,omitempty"`
	TotalGpuTime           []*LabeledMetric `protobuf:"bytes,13,rep,name=total_gpu_time,json=totalGpuTime,proto3" json:"total_gpu_time,omitempty"`
	TotalCpuTime           []*LabeledMetric `protobuf:"bytes,14,rep,name=total_cpu_time,json=totalCpuTime,proto3" json:"total_cpu_time,omitempty"`
	TotalJobDuration       []*LabeledMetric `protobuf:"bytes,15,rep,name=total_job_duration,json=totalJobDuration,proto3" json:"total_job_duration,omitempty"`
	LastBlockWatched       float64          `protobuf:"fixed64,16,opt,name=last_block_watched,json=lastBlockWatched,proto3" json:"last_block_watched,omitempty"`
	TotalJobRefused        []*LabeledMetric `protobuf:"bytes,17,rep,name=total_job_refused,json=totalJobRefused,proto3" json:"total_job_refused,omitempty"`
	TotalBilledTooMuch     []*LabeledMetric `protobuf:"bytes,18,rep,name=total_billed_too_much,json=totalBilledTooMuch,proto3" json:"total_billed_too_much,omitempty"`
}
...
func (x *Metrics) GetTotalJobsPanicked() []*LabeledMetric {
	if x != nil {
		return x.TotalJobsPanicked
	}
	return nil
}
...
var file_metrics_v1_metrics_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x95, 0x0a, 0x0a, 0x07, 0x4d,
	...
	,
	...
	,
...
var file_metrics_v1_metrics_proto_depIdxs = []int32{
	...
	1,  // 11: metrics.v1.Metrics.total_jobs_panicked:type_name -> metrics.v1.LabeledMetric
	1,  // 12: metrics.v1.Metrics.total_credit_spent:type_name -> metrics.v1.LabeledMetric
	1,  // 13: metrics.v1.Metrics.total_gpu_time:type_name -> metrics.v1.LabeledMetric
	1,  // 14: metrics.v1.Metrics.total_cpu_time:type_name -> metrics.v1.LabeledMetric
	1,  // 15: metrics.v1.Metrics.total_job_duration:type_name -> metrics.v1.LabeledMetric
	1,  // 16: metrics.v1.Metrics.total_job_refused:type_name -> metrics.v1.LabeledMetric
	1,  // 17: metrics.v1.Metrics.total_billed_too_much:type_name -> metrics.v1.LabeledMetric
	6,  // 18: metrics.v1.Job.definition:type_name -> metrics.v1.JobDefinition
	5,  // 19: metrics.v1.Job.cost:type_name -> metrics.v1.JobCost
	7,  // 20: metrics.v1.Job.time:type_name -> metrics.v1.JobTime
	4,  // 21: metrics.v1.JobCost.max_cost:type_name -> metrics.v1.BigInt
	4,  // 22: metrics.v1.JobCost.final_cost:type_name -> metrics.v1.BigInt
	4,  // 23: metrics.v1.JobTime.start:type_name -> metrics.v1.BigInt
	4,  // 24: metrics.v1.JobTime.end:type_name -> metrics.v1.BigInt
