...
const char descriptor_table_protodef_grpc_2fhealth_2fv1_2fhealth_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    " \001(\tR\007service\"\261\001\n\023HealthCheckResponse\022I\n"
    "\006status\030\001 \001(\01621.grpc.health.v1.HealthChe"
    "ckResponse.ServingStatusR\006status\"O\n\rServ"
    "ingStatus\022\013\n\007UNKNOWN\020\000\022\013\n\007SERVING\020\001\022\017\n\013N"
    "OT_SERVING\020\002\022\023\n\017SERVICE_UNKNOWN\020\0032\256\001\n\006He"
    "alth\022P\n\005Check\022\".grpc.health.v1.HealthChe"
...
::uint8_t* HealthCheckRequest::_InternalSerialize(
  ...
  if (!this->_internal_service().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "grpc.health.v1.HealthCheckRequest.service");
